...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'exhibitions' => [
            'driver'    => 'mysql',
            'host'      => env('DB_EXHIBITIONS_HOST', '127.0.0.1'),
            'port'      => env('DB_EXHIBITIONS_PORT', '3306'),
            'database'  => env('DB_EXHIBITIONS_DATABASE'),
            'username'  => env('DB_EXHIBITIONS_USERNAME', 'root'),
            'password'  => env('DB_EXHIBITIONS_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset'   => 'utf8mb4',
        ...
        'old_crm' => [
            ...
            'database'  => env('DB_OLD_CRM_DATABASE'),
