...
const routes = [
    ...
    { path: '/data-health',                component: DataHealth,   name: 'data-health',    meta: { permission: 'view data-health' } },
    { path: '/import',                     component: Import,       name: 'import',         meta: { permission: 'import contacts' } },
