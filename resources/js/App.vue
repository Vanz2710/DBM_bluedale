  ...
  <div v-else class="layout" :class="{ collapsed }">
    ...
    <aside class="sidebar">
      ...
      <nav class="nav-section">
        ...
        <router-link v-if="isAdminOrSuperAdmin" to="/admin" class="nav-link" :class="navClass('admin')">
          <span class="nav-icon">⚙️</span><span class="nav-text">Admin Panel</span>
        </router-link>
        <router-link v-if="isAdminOrSuperAdmin" to="/admin/rbac" class="nav-link" :class="navClass('rbac')">
          <span class="nav-icon">🔐</span><span class="nav-text">Access Control</span>
        </router-link>
...
function navClass(name) {
  ...
  if (name === 'rbac')        return matched === 'rbac'             ? 'active-purple' : '';
